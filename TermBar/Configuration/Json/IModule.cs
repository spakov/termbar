...
namespace Spakov.TermBar.Configuration.Json
{
    ...
    /// </summary>
    /// <remarks>Enables polymorphic instantiation of appropriate configuration
    /// objects based on <c>$module</c>. We then further use this type to
    /// instantiate appropriate models later on.</remarks>
    ...
    internal interface IModule
    {
        ...
        /// <summary>
        /// Whether the module should expand to take up as much space as
        /// possible.
        /// </summary>
