...
namespace TermBar.Styles {
  internal static class StylesHelper {
    ...
    /// cref="Style.BasedOn"/> property to the nearest ancestor's <paramref
    /// name="ancestorType"/> <see cref="Style"/>.
    /// </summary>
    /// <remarks>Does nothing to <paramref name="style"/> if a matching element
    /// is not found.</remarks>
    /// <param name="style">The style to modify.</param>
    /// <param name="startAt">The element at which to begin the search.</param>
    /// <param name="ancestorType">The type of style from which to
    /// inherit.</param>
    /// <returns><c>true</c> if a matching style was found or <c>false</c>
    /// otherwise.</returns>
