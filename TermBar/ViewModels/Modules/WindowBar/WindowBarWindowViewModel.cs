...
{
    /// <summary>
    /// A <see cref="WindowBarViewModel"/> window viewmodel.
    /// </summary>
    internal partial class WindowBarWindowViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initializes a <see cref="WindowBarWindowViewModel"/>.
        /// </summary>
        /// <param name="config"><inheritdoc
        /// cref="Views.Modules.WindowBar.WindowBarWindowView.WindowBarWindowView"
        ...
        public WindowBarWindowViewModel(Configuration.Json.TermBar config, Configuration.Json.Modules.WindowBar moduleConfig, uint processId, string name)
        {
            _config = config;
