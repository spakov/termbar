...
{
    /// <summary>
    /// A TermBar module view, which modules are expected to extend.
    /// </summary>
    ...
    internal partial class ModuleView : UserControl
    {
        ...
        /// <item>If <paramref name="moduleConfig"/> is not <c>null</c>, sets
        /// up the <c>AccentBrush</c> resource with the accent color as a <see
        /// cref="SolidColorBrush"/>.</item>
        /// </list>
        /// </remarks>
        /// <param name="config">The <see cref="Configuration.Json.TermBar"/>
        /// configuration.</param>
        /// <param name="moduleConfig">The <see cref="IModule"/> configuration
        /// for this module.</param>
