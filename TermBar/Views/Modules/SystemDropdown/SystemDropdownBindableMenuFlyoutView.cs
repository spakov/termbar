...
namespace Spakov.TermBar.Views.Modules.SystemDropdown
{
    ...
    /// </summary>
    internal sealed partial class SystemDropdownBindableMenuFlyoutView : MenuFlyout
    {
        /// <summary>
        ...
        public static readonly DependencyProperty ConfigProperty = DependencyProperty.Register(
            ...
            typeof(SystemDropdownBindableMenuFlyoutView),
            new PropertyMetadata(null, OnConfigChanged)
        );

        /// <summary>
        /// A <see cref="System.Collections.Generic.IEnumerable{T}"/> of <see
        /// cref="SystemDropdownMenuFlyoutItemView"/>s to present to the user.
        /// </summary>
        ...
        /// cref="SystemDropdownMenuFlyoutItemView"/>.
        /// </summary>
        public Action<SystemDropdownMenuFlyoutItemView>? ClickAction
        {
            get => (Action<SystemDropdownMenuFlyoutItemView>?)GetValue(ClickActionProperty);
        ...
        public static readonly DependencyProperty ClickActionProperty = DependencyProperty.Register(
            nameof(ClickAction),
            typeof(Action<SystemDropdownMenuFlyoutItemView>),
            typeof(SystemDropdownBindableMenuFlyoutView),
        ...
        private static void OnConfigChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            if (e.NewValue is Configuration.Json.TermBar)
            {
                ...
                {
                    SystemDropdownBindableMenuFlyoutView flyout = (SystemDropdownBindableMenuFlyoutView)sender;
        ...
        /// <summary>
        /// Rebuilds the contained <see
        /// cref="SystemDropdownMenuFlyoutItemView"/>s.
        /// </summary>
        private void RebuildItems()
        {
            ...
            {
                foreach (SystemDropdownMenuFlyoutItemView item in items)
                {
                    item.Click += (sender, e) => ClickAction?.Invoke(item);

                    if (!string.IsNullOrEmpty(TextPath))
                    {
                        BindingOperations.SetBinding(
                            item,
                            SystemDropdownMenuFlyoutItemView.TextProperty,
                            new Binding()
                            {
