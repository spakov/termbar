...
namespace Spakov.TermBar.Views.Modules.WindowDropdown
{
    ...
    {
        private static Style? s_fontIconStyle;
        ...
        private static void OnConfigChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            if (e.NewValue is Configuration.Json.TermBar)
            {
                ...
                if (config is not null)
                {
                    ...
                    s_fontIconStyle = new(typeof(FontIcon));
                    s_fontIconStyle.Setters.Add(new Setter(FontIcon.FontFamilyProperty, fontIconFontFamily));
        ...
        /// cref="WindowDropdownMenuFlyoutItemView"/>s.
        /// </summary>
            ...
            if (ItemsSource is IEnumerable windows)
            {
                foreach (WindowDropdownMenuFlyoutItemView window in windows)
                {
                    ...
                    if (!string.IsNullOrEmpty(IconPath))
                    {
                        ...
                        icon.Resources[typeof(FontIcon)] = s_fontIconStyle;
                        window.Icon = icon;
                    }
